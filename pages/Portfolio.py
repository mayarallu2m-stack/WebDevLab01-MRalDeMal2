...
#Description of BuzzFeed Quiz:

# The quiz I coded is meant to take take in the information
# the user selected and process how many answers were most
# like a specific type of pasta. The pasta types were indrectly assigned
# to values (ex. ravioli was "Adventurous"). You answer 5 questions and
# recieve an answer either macaroni,ravioli, penne, or spaghetti with
# an accompanying image one the sumbit button is pressed. 
